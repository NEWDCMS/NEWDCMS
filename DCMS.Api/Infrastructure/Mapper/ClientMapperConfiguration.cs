...
namespace DCMS.Api.Infrastructure.Mapper
{
    public class ClientMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        public ClientMapperConfiguration()
        {
            ...
            CreateMap<User, BusinessUserModel>();
            CreateMap<BusinessUserModel, User>();
            ...
            CreateMap<CompanySetting, CompanySettingModel>()
                .ForMember(dest => dest.SalesmanManagements, mo => mo.Ignore());
            ...
            #region 报表
            CreateMap<BrandRanking, BrandRankingModel>();
            CreateMap<BrandRankingModel, BrandRanking>();

            CreateMap<BusinessRanking, BusinessRankingModel>();
            CreateMap<BusinessRankingModel, BusinessRanking>();

            CreateMap<HotSaleRanking, HotSaleRankingModel>();
            CreateMap<HotSaleRankingModel, HotSaleRanking>();
            #endregion
            ...
            CreateMap<RetainPhoto, RetainPhotoModel>();
            CreateMap<RetainPhotoModel, RetainPhoto>();

            CreateMap<Feedback, FeedbackModel>();
            CreateMap<FeedbackModel, Feedback>();

            CreateMap<MarketFeedback, MarketFeedbackModel>();
            CreateMap<MarketFeedbackModel, MarketFeedback>();
