namespace DCMS.Core.Data
{
    ...
    public interface IUnitOfWork : IDisposable
    {
        ...
        /// </remarks>
        //void ChangeDatabase(string database, string port);
        ...
        /// <typeparam name="TEntity">The type of the entity.</typeparam>
        /// <returns>An instance of type inherited from <see cref="IRepository{TEntity}"/> interface.</returns>
        IRepositoryReadOnly<TEntity> GetReadOnlyRepository<TEntity>(bool hasCustomRepository = false) where TEntity : BaseEntity;


        ITransaction BeginOrUseTransaction(System.Data.IsolationLevel isolationLevel = System.Data.IsolationLevel.ReadCommitted, DbTransaction transaction = null);
