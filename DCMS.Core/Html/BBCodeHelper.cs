using DCMS.Core.Html.CodeFormatter;
using System.Text.RegularExpressions;

namespace DCMS.Core.Html
{
    /// <summary>
    ...
    public partial class BBCodeHelper
    {
            ...
            bool replaceUnderline, bool replaceUrl, bool replaceCode, bool replaceQuote, bool replaceImg)
        {
            ...
            //    // format the URL tags: [url=https://www.jsdcms.com]my site[/url]
            //    // becomes: <a href="https://www.jsdcms.com">my site</a>
            //    text = regexUrl1.Replace(text, $"<a href=\"$1\" rel=\"nofollow\"{(newWindow ? " target=_blank" : "")}>$2</a>");

            //    // format the URL tags: [url]https://www.jsdcms.com[/url]
            //    // becomes: <a href="https://www.jsdcms.com">https://www.jsdcms.com</a>
            ...
            if (replaceImg)
            {
                // format the img tags: [img]https://www.jsdcms.com/Content/Images/Image.jpg[/img]
                // becomes: <img src="https://www.jsdcms.com/Content/Images/Image.jpg">
