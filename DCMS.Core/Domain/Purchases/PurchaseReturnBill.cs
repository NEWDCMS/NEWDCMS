...
namespace DCMS.Core.Domain.Purchases
{
    ...
    /// 采购退货单
    /// </summary>
    public class PurchaseReturnBill : BaseBill<PurchaseReturnItem>
    {
    ...
    ///  收款账户（采购单科目映射表）
    /// </summary>
    public class PurchaseReturnBillAccounting : BaseAccount
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class PurchaseReturnBillUpdate : BaseEntity
    {
