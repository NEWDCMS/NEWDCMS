...
namespace DCMS.Core.Domain.CRM 
{
    ...
    /// </summary>
    //[Table("CRM_Relations")]
    public class CRM_RELATION : BaseEntity
    {
        #region DCMS
    ...
    /// </summary>
    //[Table("CRM_Returns")]
    public class CRM_RETURN : BaseEntity
    {
    ...
    /// </summary>
    //[Table("CRM_Orgs")]
    public class CRM_ORG : BaseEntity
    {
    ...
    /// </summary>
    //[Table("CRM_Bps")]
    public class CRM_BP : BaseEntity
    {
    ...
    /// </summary>
    //[Table("CRM_Zsntm0040")]
    public class CRM_ZSNTM0040 : BaseEntity
    {
    ...
    public class CRM_HEIGHT_CONF : BaseEntity
    {
    ...
    /// </summary>
    //[Table("CRM_Bustats")]
    public class CRM_BUSTAT : BaseEntity
    {
