...
namespace DCMS.Core.Domain.WareHouses
{
    ...
    /// 用于表示盘点任务(部分)
    /// </summary>
    public class InventoryPartTaskBill : BaseBill<InventoryPartTaskItem>
    {
    ...
    public class InventoryPartTaskItem : BaseEntity
    {
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class InventoryPartTaskBillUpdate : BaseEntity
    {
