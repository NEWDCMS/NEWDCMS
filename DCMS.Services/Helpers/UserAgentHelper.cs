...
namespace DCMS.Services.Helpers
{
    ...
    public partial class UserAgentHelper : IUserAgentHelper
    {
        ...
        protected virtual BrowscapXmlHelper GetBrowscapXmlHelper()
        {
            ...
            //no database created
            if (string.IsNullOrEmpty(_dcmsConfig.UserAgentStringsPath))
            {
                return null;
            }
            ...
            lock (_locker)
            {
                ...
                var userAgentStringsPath = _fileProvider.MapPath(_dcmsConfig.UserAgentStringsPath);
                var crawlerOnlyUserAgentStringsPath = !string.IsNullOrEmpty(_dcmsConfig.CrawlerOnlyUserAgentStringsPath)
                    ? _fileProvider.MapPath(_dcmsConfig.CrawlerOnlyUserAgentStringsPath)
                    : string.Empty;
        ...
        public virtual bool IsSearchEngine()
        {
            ...
            //more info: https://www.jsdcms.com/boards/t/17711/unhandled-exception-request-is-not-available-in-this-context.aspx
            try
            {
