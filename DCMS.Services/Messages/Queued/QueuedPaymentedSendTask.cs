...
{
    /// <summary>
    /// 交账完成/撤销发送队列 DCMS.Services.Tasks.QueuedPaymentedSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedPaymentedSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedPaymentedSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.Paymented, null, DCMSMessageDefaults.MaxTries, null,
               true, false);
