...
{
    /// <summary>
    /// 转单/签收完成发送队列 DCMS.Services.Tasks.QueuedTransferCompletedSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedTransferCompletedSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedTransferCompletedSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.TransferCompleted, null, DCMSMessageDefaults.MaxTries, null, true, false);
