...
{
    /// <summary>
    /// 交账提醒发送队列 DCMS.Services.Tasks.QueuedHoldSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedHoldSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedHoldSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            ...
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.Hold, null, DCMSMessageDefaults.MaxTries, null,
                true, false);
