...
{
    /// <summary>
    /// 提醒门店欠款(收款)发送队列  DCMS.Services.Tasks.QueuedReceiptSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedReceiptSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedReceiptSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.Receipt, null, DCMSMessageDefaults.MaxTries, null,
               true, false);
