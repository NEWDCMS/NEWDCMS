...
{
    /// <summary>
    /// 客户流失预警任务发送队列 DCMS.Services.Tasks.QueuedLostWarningSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedLostWarningSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedLostWarningSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.LostWarning, null, DCMSMessageDefaults.MaxTries, null,
                true, false);
