...
{
    /// <summary>
    /// 盘点完成发送队列 DCMS.Services.Tasks.QueuedInventoryCompletedSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedInventoryCompletedSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedInventoryCompletedSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.InventoryCompleted, null, DCMSMessageDefaults.MaxTries, null,
               true, false);
