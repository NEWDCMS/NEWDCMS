...
{
    /// <summary>
    /// 库存预警任务发送队列 DCMS.Services.Tasks.QueuedInventoryWarningSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedInventoryWarningSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedInventoryWarningSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.InventoryWarning, null, DCMSMessageDefaults.MaxTries, null,
                true, false);
