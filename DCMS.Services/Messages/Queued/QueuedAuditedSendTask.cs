...
{
    /// <summary> 
    /// 审核完成发送队列 DCMS.Services.Tasks.QueuedAuditedSendTask,DCMS.Services
    /// </summary>
    public partial class QueuedAuditedSendTask : IScheduleTask
    {
        private readonly IQueuedMessageService _queuedMessageService;
        private readonly IMessageSender _messageSender;
        private readonly ILogger _logger;

        public QueuedAuditedSendTask(IQueuedMessageService queuedMessageService,
        ...
        public void Execute()
        {
            var queuedMessages = _queuedMessageService.SearchMessages(null, (int)MTypeEnum.Audited, null, DCMSMessageDefaults.MaxTries, null,
               true, false);
