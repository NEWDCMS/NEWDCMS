...
namespace DCMS.ViewModel.Models.Sales
{
    ...
    public partial class SaleReservationBillListModel : BaseModel, IParentList
    {

        public SaleReservationBillListModel()
        {
            PagingFilteringContext = new PagingFilteringModel();
            Lists = new List<SaleReservationBillModel>();
            DynamicColumns = new List<string>();
        }

        public PagingFilteringModel PagingFilteringContext { get; set; }
        public IList<SaleReservationBillModel> Lists { get; set; }
    ...
    /// 销售订单
    /// </summary>
    //[Validator(typeof(SaleReservationBillValidator))]
    public class SaleReservationBillModel : BaseBillModel, IParentList
    {

        public SaleReservationBillModel()
        {
            Items = new List<SaleReservationItemModel>();
        ...
        public SelectList SaleReservationBillDefaultAmounts { get; set; }
        ...
        public IList<SaleReservationItemModel> Items { get; set; }
    ...
    ///  收款账户（销售单科目映射表）
    /// </summary>
    public class SaleReservationBillAccountingModel : BaseAccountModel
    {
    ...
    public class SaleReservationBillUpdateModel : BaseBalance
    {
        ...
        /// 项目
        /// </summary>
        public List<SaleReservationItemModel> Items { get; set; }

        /// <summary>
        /// 收款账户
        /// </summary>
        public List<SaleReservationBillAccountingModel> Accounting { get; set; }
