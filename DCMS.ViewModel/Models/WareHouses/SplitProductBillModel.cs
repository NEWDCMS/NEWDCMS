...
namespace DCMS.ViewModel.Models.WareHouses
{
    ...
    /// 用于表示库存商品拆分单列表
    /// </summary>
    public partial class SplitProductBillListModel : BaseModel
    {
        public SplitProductBillListModel()
        {
    ...
    /// 用于表示库存商品组合单
    /// </summary>
    public class SplitProductBillModel : BaseEntityModel
    {
    ...
    public class SplitProductItemModel : ProductBaseModel
    {
        ...
        public int SplitProductBillId { get; set; } = 0;
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class SplitProductUpdateModel : BaseEntityModel
    {
