...
namespace DCMS.ViewModel.Models.WareHouses
{
    ...
    /// 用于表示盘点任务(整仓)列表
    /// </summary>
    public partial class InventoryAllTaskBillListModel : BaseModel
    {
        public InventoryAllTaskBillListModel()
        {
        ...
        public IList<InventoryAllTaskBillModel> Items { get; set; }
    ...
    /// 用于表示盘点任务(整仓)
    /// </summary>
    public class InventoryAllTaskBillModel : BaseEntityModel
    {

        public InventoryAllTaskBillModel()
        {
            Items = new List<InventoryAllTaskItemModel>();
        }
        public IList<InventoryAllTaskItemModel> Items { get; set; }
    ...
    public class InventoryAllTaskItemModel : ProductBaseModel
    {
        ...
        public int InventoryAllTaskBillId { get; set; } = 0;
    ...
    /// 项目保存或者编辑
    /// </summary>
    public class InventoryAllTaskUpdateModel : BaseEntityModel
    {

        public InventoryAllTaskUpdateModel()
        {
            Items = new List<InventoryAllTaskItemModel>();
        }
        ...
        /// 项目
        /// </summary>
        public List<InventoryAllTaskItemModel> Items { get; set; }
