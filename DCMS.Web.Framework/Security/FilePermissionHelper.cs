...
namespace DCMS.Web.Framework.Security
{
    ...
    public static class FilePermissionHelper
    {
        ...
        public static IEnumerable<string> GetFilesWrite()
        {
            ...
            {
                //插件
                //fileProvider.MapPath("~/App_Data/plugins.json"),
                //数据库配置
                //fileProvider.MapPath(DCMSDataSettingsDefaults.FilePath)
                //快速安装
                fileProvider.MapPath(DCMSDataSettingsDefaults.SetupConfigFilePath)
            };
        }
