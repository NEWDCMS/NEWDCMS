...
{
    /// <summary>
    /// dcms-action-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("dcms-action-confirmation", Attributes = ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class DCMSActionConfirmationTagHelper : TagHelper
    {
        ...
        public DCMSActionConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
