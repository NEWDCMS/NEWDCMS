...
{
    /// <summary>
    /// dcms-delete-confirmation tag helper
    /// </summary>
    [HtmlTargetElement("dcms-delete-confirmation", Attributes = ModelIdAttributeName + "," + ButtonIdAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class DCMSDeleteConfirmationTagHelper : TagHelper
    {
        ...
        public DCMSDeleteConfirmationTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
