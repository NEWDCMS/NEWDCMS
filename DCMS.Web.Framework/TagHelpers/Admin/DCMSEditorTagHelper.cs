...
{
    /// <summary>
    /// dcms-editor tag helper
    /// </summary>
    [HtmlTargetElement("dcms-editor", Attributes = ForAttributeName, TagStructure = TagStructure.WithoutEndTag)]
    public class DCMSEditorTagHelper : TagHelper
    {
        ...
        public DCMSEditorTagHelper(IHtmlHelper htmlHelper)
        {
