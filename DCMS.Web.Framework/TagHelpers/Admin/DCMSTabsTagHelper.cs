...
{
    /// <summary>
    /// dcms-tabs tag helper
    /// </summary>
    [HtmlTargetElement("dcms-tabs", Attributes = IdAttributeName)]
    public class DCMSTabsTagHelper : TagHelper
    {
        ...
        public DCMSTabsTagHelper(IHtmlHelper htmlHelper)
        {
        ...
        public override async Task ProcessAsync(TagHelperContext context, TagHelperOutput output)
        {
            ...
            context.Items.Add(typeof(DCMSTabsTagHelper), tabContext);
    ...
    /// "dcms-tab tag helper
    /// </summary>
    [HtmlTargetElement("dcms-tab", ParentTag = "dcms-tabs", Attributes = NameAttributeName)]
    public class NopTabTagHelper : TagHelper
    {
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            //add to context
            var tabContext = (List<NopTabContextItem>)context.Items[typeof(DCMSTabsTagHelper)];
