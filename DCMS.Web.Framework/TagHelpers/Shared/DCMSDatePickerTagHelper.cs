...
{
    /// <summary>
    /// 自定义 date-picker tag helper
    /// </summary>
    [HtmlTargetElement("dcms-date-picker",
        Attributes = DayNameAttributeName + "," + MonthNameAttributeName + "," + YearNameAttributeName,
        TagStructure = TagStructure.WithoutEndTag)]
    public class DCMSDatePickerTagHelper : TagHelper
    {
        ...
        public DCMSDatePickerTagHelper(IHtmlGenerator generator, IHtmlHelper htmlHelper)
        {
            Generator = generator;
        ...
        public override void Process(TagHelperContext context, TagHelperOutput output)
        {
            ...
            days.AppendFormat("<option value='{0}'>{1}</option>", "0", "天");
            for (var i = 1; i <= 31; i++)
            {
            ...
            months.AppendFormat("<option value='{0}'>{1}</option>", "0", "月");
            for (var i = 1; i <= 12; i++)
            {
            ...
            years.AppendFormat("<option value='{0}'>{1}</option>", "0", "年");
