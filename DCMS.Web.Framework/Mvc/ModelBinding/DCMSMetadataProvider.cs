...
namespace DCMS.Web.Framework.Mvc.ModelBinding
{
    ...
    /// </summary>
    public class DCMSMetadataProvider : IDisplayMetadataProvider
    {
        /// <summary>
        ...
        public void CreateDisplayMetadata(DisplayMetadataProviderContext context)
        {
            ...
            foreach (var additionalValue in additionalValues)
            {
                ...
                {
                    throw new DCMSException("There is already an attribute with the name '{0}' on this model", additionalValue.Name);
                }
